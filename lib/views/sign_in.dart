        ...
        child: Center(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Image.asset('assets/scholar.png', width: 150),
                Container(
                  width: double.infinity,
                  padding: EdgeInsets.symmetric(vertical: 5),
                    color: Colors.grey.withOpacity(0.1),
                    child: Center(child: Text('SIGN IN', style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: kara.Colors.green),))
                ),
                onerror?Container(
                  child: Column(
                    children: [
